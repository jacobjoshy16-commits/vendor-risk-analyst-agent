# The SaaS companion (NHI / AIV monitoring)

> Split out of the README. This is the original product the repo grew from:
> an independent monitor for vendor **non-human identities** and agentic
> features across SaaS tenants. It is **not** the NERC CIP tool this repo is
> now about, it needs no OT data, and nothing in the CIP path depends on it.
> See the [README](../README.md) for the product.
